/*
*------------------------------------------
* pthread_Ejercicio2 - Inciso C.cpp
* -----------------------------------------
...
* para crear hilos y su respectivo join en el
* mismo ciclo y se imprimira “Hello world thread 
* No. X” colocando el número del hilo en lugar de 
* la “X”.
*------------------------------------------
*/
...
int main(int argc, char *argv[]) {
	...
	for (t=0; t< NUM_THREADS; t++) {
        ...
        rc = pthread_join(threadsID[t], NULL); //Se realiza el join de cada hilo en el mismo ciclo
	}
